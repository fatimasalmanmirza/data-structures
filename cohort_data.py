...
#     all_hogwarts = ([sorted(dumbledores_army)] + [sorted(gryffindor)] 
...
def all_students_tuple_list(filename):
    ...
    for line in filename:
        ...
        for word in words:
            if words[2] != '':
                before_tuple =  words[0] + ' ' + words[1] , words[2], words[3] , words[4]
        student_list.append(before_tuple)
    return(student_list)


def find_cohort_by_student_name(student_list):
    #THIS ONE REQUIRES USER INPUT
